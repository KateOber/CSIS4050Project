    ...
    public static class SeedDatabaseExtension
    {
        ...
        public static void SeedDatabase(this TheMobileShopEntities context)
        {
            ...
            List<Inventory> inventoriesList = new List<Inventory>()
            {
                ...
                new Inventory {ProductId = 15, Name = "EarPods In-Ear Headphones with Lightning", Description = "Design is defined by the geometry of the ear, making them more comfortable for more people", Quantity = 20, Category = categories[3], Brand = "Apple", Cost=29.99,Price = 34.99 },
                new Inventory {ProductId = 16, Name = "1.83m (6 ft.) Lightning to Aux Cable - Black", Description = "3.5 mm connector is ideal for using an Apple device to listen to music through your car speakers", Quantity = 10, Category = categories[3], Brand = "Belkin",Cost = 39.99,Price = 45.99 },
                new Inventory {ProductId = 17, Name = "Galaxy Tab S6 Lite 10.4 128GB Android Tablet", Description = "Android OS with One UI 2 offers fast boot times, efficient power management, and much more", Quantity = 4, Category = categories[2], Brand = "Samsung",Cost = 429.99, Price = 489.99},
