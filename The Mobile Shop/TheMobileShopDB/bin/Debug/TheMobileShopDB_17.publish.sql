...
ALTER TABLE [dbo].[TransactionProducts]
    ADD CONSTRAINT [FK_TransactionProducts_Inventory_ProductId] FOREIGN KEY ([ProductId]) REFERENCES [dbo].[Inventory] ([ProductId]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[TransactionProducts]
    ADD CONSTRAINT [FK_TransactionProducts_Transactions_TransactionId] FOREIGN KEY ([TransactionId]) REFERENCES [dbo].[Transactions] ([TransactionId]) ON DELETE CASCADE;
...
ALTER TABLE [dbo].[Transactions]
    ADD CONSTRAINT [FK_Transactions_Employees_EmployeeId] FOREIGN KEY ([EmployeeId]) REFERENCES [dbo].[Employees] ([EmployeeId]) ON DELETE CASCADE;
