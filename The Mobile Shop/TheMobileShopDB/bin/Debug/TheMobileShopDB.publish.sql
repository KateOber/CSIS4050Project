...
CREATE TABLE [dbo].[Inventory] (
    ...
    [GrossPrice]  NUMERIC (18)   NULL,
    [NetPrice]    NUMERIC (18)   NULL,
    [Tax]         NUMERIC (18)   NULL,
...
GO
PRINT N'Creating [dbo].[FK_Transactions_Inventory_ProductId]...';


GO
ALTER TABLE [dbo].[Transactions]
    ADD CONSTRAINT [FK_Transactions_Inventory_ProductId] FOREIGN KEY ([ProductId]) REFERENCES [dbo].[Inventory] ([ProductId]);
