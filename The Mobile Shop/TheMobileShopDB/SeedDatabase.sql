...
INSERT INTO [dbo].[Inventory] ([ProductId],[Name],[Description],[Quantity],[CategoryId],[Brand],[Cost],[Price]) VALUES ('15','EarPods In-Ear Headphones with Lightning','Design is defined by the geometry of the ear, making them more comfortable for more people','20','3','Apple','29.99','34.99');
INSERT INTO [dbo].[Inventory] ([ProductId],[Name],[Description],[Quantity],[CategoryId],[Brand],[Cost],[Price]) VALUES ('16','1.83m (6 ft.) Lightning to Aux Cable - Black','3.5 mm connector is ideal for using an Apple device to listen to music through your car speakers','10','3','Belkin','39.99','45.99');
INSERT INTO [dbo].[Inventory] ([ProductId],[Name],[Description],[Quantity],[CategoryId],[Brand],[Cost],[Price]) VALUES ('17','Galaxy Tab S6 Lite 10.4 128GB Android Tablet','Android OS with One UI 2 offers fast boot times, efficient power management, and much more','4','2','Samsung','429.99','489.99');
